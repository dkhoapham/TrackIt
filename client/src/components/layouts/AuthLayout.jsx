...
const AuthLayout = ({children}) => {
    return <div className="flex">
                <div className="w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12 rounded-lg">
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
                ...
                <div className="grid grid-cols-1 z-20">
                    <StatsInfoCard
                        ...
                        label="Track You Income and Expense"
                        value="430,000"
                        color="bg-primary"
                    />
                 </div>
                ...
                <img
                    src={CARD_2}
                    className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 rounded-[15px]"
                />
            </div>
        </div>;
};
